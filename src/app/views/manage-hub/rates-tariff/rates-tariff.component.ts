...
@Component({
  selector: 'rates-tariff',
  templateUrl: './rates-tariff.component.html',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class RatesTariffComponent implements OnInit {
  registerUserForm!: FormGroup;
  visible: boolean = false;
  modalTitle: string = 'Manage Rate Tariff';
  isEditMode: boolean = false;
  ratesTariffTypes= [];
  ratesTariffList: RatesTariffDto[] = [];
